...
1. Install [Google Tasks integration](https://www.home-assistant.io/integrations/google_tasks/) for Home Assistant (**follow instructions in [Scenario 2: You do not have credentials set up yet](https://www.home-assistant.io/integrations/google_tasks/#scenario-2-you-do-not-have-credentials-set-up-yet) to create credentials)**.
